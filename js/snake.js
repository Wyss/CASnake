    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createGameEndElement(message, elmId, elmClassName) {
            ...
            gameEndTxt.innerHTML = "SyntheSnake<p></p>" + message + "<p></p>";
        ...
        function createTryAgainElement() {
            return createGameEndElement("Your synthesis failed :(", "sbTryAgain", "snake-try-again-dialog");
        }

        function createWinElement() {
            return createGameEndElement("You successfully synthesized! :)", "sbWin", "snake-win-dialog");
        }
